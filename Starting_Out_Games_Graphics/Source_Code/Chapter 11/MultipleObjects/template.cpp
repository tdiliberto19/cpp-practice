...
Sprite spaceship1(SPACESHIP1_INDEX, "Space/spaceship.png");
Sprite spaceship2(SPACESHIP2_INDEX, "Space/spaceship.png");
Sprite spaceship3(SPACESHIP3_INDEX, "Space/spaceship.png");
